...
export default function Error({
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', backgroundColor: '#0A0F1E', color: '#FFFFFF', padding: '24px' }}>
      <div style={{ maxWidth: '560px', width: '100%', border: '1px solid #1E2D4A', borderRadius: '16px', backgroundColor: '#0D1428', padding: '28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
          ...
          <div>
            <div style={{ fontSize: '12px', color: '#8A9BB5', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Error boundary</div>
            <h1 style={{ fontSize: '22px', marginTop: '2px' }}>MemoryMerge UI hit an error</h1>
          </div>
        </div>
        <p style={{ color: '#8A9BB5', lineHeight: 1.7, marginBottom: '18px' }}>
          The live dashboard failed to render. This boundary keeps the app stable so you can retry without losing state.
        </p>
